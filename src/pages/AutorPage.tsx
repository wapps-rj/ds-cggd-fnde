...
const skills = [
  ...
  { icon: <LayoutGrid size={20} />, label: "Design System", desc: "Criação de um ecossistema de padrões para produtos digitais consistentes, reunindo componentes reutilizáveis, diretrizes de desenvolvimento e documentação estruturada para garantir escala, governança e eficiência." },
