  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex pt-14 min-h-screen">
        ...
        {/* Sidebar */}
        <aside
          className={`fixed top-14 bottom-0 left-0 w-64 bg-sidebar text-sidebar-foreground z-40 overflow-y-auto transition-transform duration-200 ${
        ...
        >
          ...
          <nav className="px-2 pb-6" aria-label="Navegação do design system">
